...
def parties_list():
    return [
        (
            ...
            "9823462810",
            "F-N",
            datetime.fromisoformat("2019-07-29 06:21:32.000+05:30"),
        ),
        (
            date(2022, 8, 2),
            "6982391061",
            "9823462811",
            "F-N",
            datetime.fromisoformat("2018-08-31 05:27:22.000+05:30"),
        ),
        (
            date(2022, 8, 2),
            "6982391062",
            "9823462812",
            "F-N",
            datetime.fromisoformat("2018-08-25 15:50:29.000+05:30"),
        ),
        (
            date(2022, 8, 2),
            "6982391063",
            "9823462813",
            "F-N",
            datetime.fromisoformat("2018-05-11 07:23:28.000+05:30"),
        ),
        (
            date(2022, 8, 2),
            "6982391064",
            "9823462814",
            "F-N",
            datetime.fromisoformat("2019-06-06 14:18:12.000+05:30"),
        ),
        (
            date(2022, 8, 2),
            "6982391065",
            "9823462815",
            "F-N",
            datetime.fromisoformat("2019-05-04 05:12:37.000+05:30"),
        ),
        (
            date(2022, 8, 2),
            "6982391066",
            "9823462816",
            "F-N",
            datetime.fromisoformat("2019-05-15 10:39:29.000+05:30"),
        ),
        (
            date(2022, 8, 2),
            "6982391067",
            "9823462817",
            "F-N",
            datetime.fromisoformat("2018-05-16 09:53:04.000+05:30"),
        ),
        (
            date(2022, 8, 2),
            "6982391068",
            "9823462818",
            "F-N",
            datetime.fromisoformat("2017-11-27 01:20:12.000+05:30"),
        ),
        (
            date(2022, 8, 2),
            "6982391067",
            "9823462820",
            "F-S",
            datetime.fromisoformat("2017-11-20 14:18:05.000+05:30"),
        ),
        (
            date(2022, 8, 2),
            "6982391067",
            "9823462821",
            "F-S",
            datetime.fromisoformat("2018-07-19 18:56:57.000+05:30"),
        ),
    ]
...
def test_get_contract(spark, expected_contract_df):
    ...
    assertDataFrameEqual(
        expected_contract_df, actual_contract_df, ignoreColumnName=True
    )
...
def test_kafka_kv_df(spark, expected_final_df):
    ...
    party_address_df = Transformations.join_party_address(
        relations_df, relation_address_df
    )
    data_df = Transformations.join_contract_party(contract_df, party_address_df)
    actual_final_df = Transformations.apply_header(spark, data_df).select(
        "keys", "payload"
    )
